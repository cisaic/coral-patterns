...
def average_over_seeds(N, cfg_base, seeds):
    ...
    for s in seeds:
        ...
        cluster, origin, _, max_r2 = simulate_dla(**cfg)
...
def plot_data_collapse(masses, num_seeds=10):
    cfg_base = BASELINE_DEFAULTS.copy()
    ...
    ax.set_title(f"Collapse of scaled mass M(r)/N as a function of scaled radius (r/R)^D in 8-Neighborhood DLA clusters")
