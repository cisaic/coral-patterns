...
def growth_mode_probability(cluster, growth_site, growth_mode, available_neighbors_indices):
    """
...
def friendliness_probability(cluster, growth_site, friendliness, available_neighbors, available_neighbors_indices, neighborhood, sharpness):
    """
...
def attach_to_cluster_neighborhood(cluster, growth_site, growth_mode, friendliness, neighborhood, sharpness, rng):
    ...
    growth_mode_probabilities = growth_mode_probability(cluster, growth_site, growth_mode, available_neighbors_indices)
    neighbor_probabilities = friendliness_probability(cluster, growth_site, friendliness, available_neighbors, available_neighbors_indices, neighborhood, sharpness)
